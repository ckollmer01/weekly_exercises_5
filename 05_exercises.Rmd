...
small_trains %>%
  ...
  filter(arrival_station %in% c("PARIS LYON")) %>%
  ggplot(mapping = aes(x = journey_time_avg,
                       y = delayed_number)) +
  geom_dotplot() #missing y aesthetic somehow
...
cum_tomato_harvest <- garden_harvest %>%
  ...
  mutate(cum_weight_lbs = cumsum(weight_lbs),
         variety = fct_reorder(variety,cum_weight_lbs),
        day_of_week = wday(date, label = TRUE))

cum_tomato_harvest %>%
  ggplot(mapping = aes(day_of_week, cum_weight_lbs, fill = variety)) +
  geom_area() +
